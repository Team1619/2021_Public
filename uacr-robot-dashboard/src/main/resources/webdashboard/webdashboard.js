    ...
    socket.onmessage = function (message) {
        ...
        switch (messageData.get("response")) {
            ...
            case "connected":
                ...
                sessionStorage["ips_selected_auto"] = "undefined";
                break;
        }
    };
}
...
setInterval(function () {
    if (sessionStorage["ips_selected_auto"] !== "undefined") {
        //If sessionStorage contains the selected auto, use it to set the auto text in the auto button
        document.getElementById("autoButton").innerText = sessionStorage["ips_selected_auto"];
    } else {
